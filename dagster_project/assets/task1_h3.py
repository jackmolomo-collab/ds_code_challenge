...
def task1_h3():
    ...
    # ---------------------------------------------------------
    # 5. Load reference sr_hex dataset
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 7. Validate generated H3 against sr_hex
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 9. Write H3-enriched service requests
    # ---------------------------------------------------------
    ...
    writer.write_dataframe(
        result,
        "service_requests_h3.json"
    )

    metrics.record(
        operation="write_h3_service_requests",
        start_time=start,
        records=len(result),
    )
